...
### Ultra-modern ZSH configuration for Kali Linux
**Cyber-themed prompt • 300+ aliases • Custom penetration testing functions**

[![Kali Linux](https://img.shields.io/badge/Kali_Linux-557C94?style=for-the-badge&logo=kalilinux&logoColor=white)](https://www.kali.org/)
[![ZSH](https://img.shields.io/badge/ZSH-1.2.5-1E90FF?style=for-the-badge&logo=gnu-bash&logoColor=white)](https://www.zsh.org/)
[![License](https://img.shields.io/badge/License-MIT-green?style=for-the-badge)](LICENSE)
[![Aliases](https://img.shields.io/badge/Aliases-300%2B-orange?style=for-the-badge)](https://github.com/zar7real/kali-cyber-terminal)
...
#### 4️⃣ Install Plugins (Recommended)
...
| **Oh My Zsh** | Framework & plugins | [Install Guide](https://ohmyz.sh/#install) |
...
**`quickscan <target>`**  
Fast network reconnaissance with service detection  
...
**`msflistener [port]`**  
Metasploit handler quick-start  
• **Default:** Port 4444  
...
[Report Bug](https://github.com/zar7real/kali-cyber-terminal/issues) • [Request Feature](https://github.com/zar7real/kali-cyber-terminal/issues) • [Read Guidelines](CONTRIBUTING.md)
